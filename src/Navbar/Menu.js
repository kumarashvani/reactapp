    ...
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                <Link className="navbar-brand" to="/"rel="noreferrer">{props.title}</Link>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <Link className="nav-link active" aria-current="page" rel="noreferrer" to="/">Home</Link>
                    </li>
                    <li className="nav-item">
                    <Link className="nav-link" to="/about" rel="noreferrer">{props.aboutText}</Link>
                    </li>
                    <li className="nav-item">
                    <Link className="nav-link" to="/state" rel="noreferrer">State</Link>
                    </li>
                </ul>
